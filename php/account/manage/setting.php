            ...
            <div class="col-md-offset-1 col-md-3">
                <div class="panel panel-default panel-profile">
                        ...
                        <ul class="list-group">
                            ...
                            <a class="list-group-item active" href="setting.php">General</a>
  <a class="list-group-item " href="pass.php">Password</a>
  <a class="list-group-item " href="delac.php">Delete Account</a>
</ul>
                ...
                <div class="panel panel-default panel-profile">
                     ...
                     <div class="row">
                         ...
                         <div style="padding:0px 10px;" class="form-group">
                             ...
                             <input id="username" onkeyup="return username_validate(this.value);"  type="text" value="<?php echo $username; ?>" name="username" class="form-control">
